...
def do_selective_prediction(y_test, test_pred, test_pred_perp, layer, parameters=None):
    ...
    for threshold in thresholds:
        ...
        coverage_combined = compute_coverage((test_pred + test_pred_perp) / 2, threshold)
        risk_combined = compute_risk((test_pred + test_pred_perp) / 2, y_test, threshold)
        data.append(["Ensemble", threshold, coverage_combined, risk_combined])
